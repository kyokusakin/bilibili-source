...
dependencies {
  implementation("io.github.kyokusakin:bilibili-common:1.0.5")
}
```
...
lavalink:
  plugins:
    - dependency: "io.github.kyokusakin:bilibili-plugin:1.0.5"
...
```text
https://repo1.maven.org/maven2/io/github/kyokusakin/bilibili-plugin/1.0.5/
```
...
- Example release tag: `bilibili-source-1.0.5`
